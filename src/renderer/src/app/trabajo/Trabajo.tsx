      ...
      <section className="grid grid-cols-4 gap-4 w-full">
        ...
        >
          ...
          >
            ...
            />
            <path
              d="M99.837 51.1288C99.837 54.0676 99.8384 57.0079 99.8356 59.9467C99.8342 61.6268 98.8968 62.6404 97.2882 62.6433C91.6176 62.655 85.9455 62.6535 80.2748 62.6433C78.62 62.6404 77.6685 61.6326 77.6671 59.9175C77.6643 54.0385 77.6643 48.1609 77.6671 42.2818C77.6671 40.5507 78.613 39.5574 80.2622 39.556C85.9329 39.5531 91.6049 39.5516 97.2756 39.556C98.8912 39.556 99.8314 40.5434 99.8356 42.2366C99.8412 45.2002 99.837 48.1638 99.8356 51.1274L99.837 51.1288Z"
              fill="#1C2E3D"
            />
            <rect
              x="0.548828"
              ...
              fill="#1C2E3D"
            />
            <circle cx="7.85079" cy="86.2644" r="2.4338" fill="#1C2E3D" />
            <circle cx="2.98458" cy="93.5659" r="2.4338" fill="#1C2E3D" />
            <circle cx="12.717" cy="93.5659" r="2.4338" fill="#1C2E3D" />
            <circle cx="40.3" cy="86.2649" r="2.4338" fill="#1C2E3D" />
            <circle cx="35.4338" cy="93.5661" r="2.4338" fill="#1C2E3D" />
            <circle cx="45.1662" cy="93.5661" r="2.4338" fill="#1C2E3D" />
            <circle cx="72.7483" cy="86.2651" r="2.4338" fill="#1C2E3D" />
            <circle cx="67.882" cy="93.5664" r="2.4338" fill="#1C2E3D" />
            <circle cx="77.6145" cy="93.5664" r="2.4338" fill="#1C2E3D" />
            <circle cx="105.2" cy="86.2651" r="2.4338" fill="#1C2E3D" />
            <circle cx="100.334" cy="93.5664" r="2.4338" fill="#1C2E3D" />
            <circle cx="110.067" cy="93.5664" r="2.4338" fill="#1C2E3D" />
            <circle cx="137.652" cy="86.2649" r="2.4338" fill="#1C2E3D" />
            <circle cx="132.785" cy="93.5664" r="2.4338" fill="#1C2E3D" />
            <circle cx="142.52" cy="93.5664" r="2.4338" fill="#1C2E3D" />
            <circle cx="170.105" cy="86.2651" r="2.4338" fill="#1C2E3D" />
