    ...
    <article className="w-full flex flex-col content-center justify-around h-[100%] px-20">
      ...
      <section className="flex flex-col gap-2 content-center items-center justify-between">
        ...
        <div className="w-full flex justify-between">
          <p className="text-[20px] text-white font-medium">Aspersor H - 30</p>
          <p className="text-[20px] text-white font-medium">TESTING {percentageLoading}%</p>
        </div>
      </section>
      <section className="flex justify-between gap-4">
        <div className="flex flex-col gap-2">
          <div className="flex gap-2 items-center">
            ...
            <p className="text-white text-[12px]">Funcionamiento regular</p>
          </div>
          <div className="flex gap-2 items-center">
            <svg
              width="16"
            ...
            <p className="text-white text-[12px]">Funcionamiento fuera de rango</p>
          </div>
          <div className="flex gap-2 items-center">
            <svg
              width="16"
            ...
            <p className="text-white text-[12px]">Sin funcionamiento</p>
          </div>
        </div>
