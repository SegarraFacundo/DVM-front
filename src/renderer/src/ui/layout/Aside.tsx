...
export function Aside() {
  ...
  return (
    ...
    >
      <ul className="mt-[50px] ml-[15px] mr-[21px] h-[680px] flex flex-col">
        {items}
        <li key={-1} onClick={() => window.api.invoke.apagarDispositivo()} className="mt-auto border-t-gray-800 border-t-2 pt-6">
          <ItemMenuAside
            itemMenu={{
