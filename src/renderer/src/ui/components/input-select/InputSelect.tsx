...
export function InputSelect ({ label, name, data, register, options = {}, errors, withAdd = false }: Props) {
  ...
  return (
    <div className='flex flex-col mt-[46px]'>
      ...
      <select
        className={clsx('relative h-[64px] w-[366px] rounded-[5px] bg-[#172530] border border-solid border-[#fff] pl-[18px] text-white bg-[url("../../resources/arrow-down.svg")] appearance-none bg-no-repeat mr-8 p-4 bg-[94%]', {
